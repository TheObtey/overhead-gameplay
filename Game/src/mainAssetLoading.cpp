...
Node& LoadScene(Node& node)
{
    ...
    sptr<SceneData> Scene1 = AssetLoader::LoadSceneFromFile("res/fbx/Rooms/HUB_Recenter.fbx", AssetLoader::FileType::FBX);
    ...
    EditorSerializer::SaveNode("HUBATZERO.nd", pNode1);
